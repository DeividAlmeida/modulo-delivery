...
section.barraDados {background:#fff; border-bottom:1px #dedede solid; display:table; width:100%;}
	...
	section.barraDados .horario-atendimento p .fa-clock {position:absolute; left:10px; top:50%; transform:translateY(-50%); font-size:34px; color:#a9a9a9; background:url(../img/icone-relogio.png) center center no-repeat; text-indent:-9999px; width:34px;}
	...
	section.barraDados .tempoEntrega {padding-left:47px; background:url(../img/icon-tempo-entrega.png) left center no-repeat;}
    ...
    border: 1px transparent solid; border-bottom: 0; width: 100%; background:url(../img/icone-cartao.png) 10px center no-repeat;}
...
.botoes .botao.openBasket:hover {background:#ececec;}
	.botoes .botao.openBasket .title {padding:20px; padding-left:65px; background:url(../img/cart-icon.png) 20px center no-repeat; background-size:34px;}
